...
selective_scan_fwd(const paddle::Tensor &u, const paddle::Tensor &delta,
    ...
    DISPATCH_ITYPE_FLOAT_AND_HALF_AND_BF16(u.type(), "selective_scan_fwd", [&] {
        DISPATCH_WTYPE_FLOAT_AND_COMPLEX(A.type(), "selective_scan_fwd", [&] {
...
selective_scan_bwd(const paddle::Tensor &u, const paddle::Tensor &delta,
    ...
    DISPATCH_ITYPE_FLOAT_AND_HALF_AND_BF16(u.type(), "selective_scan_bwd", [&] {
        DISPATCH_WTYPE_FLOAT_AND_COMPLEX(A.type(), "selective_scan_bwd", [&] {
