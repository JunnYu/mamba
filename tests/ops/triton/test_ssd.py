...
from mamba_ssm_paddle.ops.triton.ssd_chunk_state import _chunk_cumsum_fwd, _chunk_state_fwd
...
from mamba_ssm_paddle.ops.triton.ssd_state_passing import _state_passing_fwd
from mamba_ssm_paddle.ops.triton.ssd_chunk_scan import chunk_scan, chunk_scan_ref
from mamba_ssm_paddle.ops.triton.ssd_combined import mamba_chunk_scan_combined, mamba_chunk_scan, ssd_chunk_scan_combined_ref, ssd_selective_scan
from mamba_ssm_paddle.ops.triton.ssd_combined import mamba_split_conv1d_scan_combined, mamba_split_conv1d_scan_ref
...
def test_chunk_state_varlen(chunk_size, ngroups, dtype):
    ...
    seq_idx = paddle.concat([paddle.full((s,), i, dtype=paddle.int32) for i, s in enumerate(seqlens)], axis=0).unsqueeze(0)
    dim = 4096
    # dim = 64
    headdim = 64
    # dim = 32
