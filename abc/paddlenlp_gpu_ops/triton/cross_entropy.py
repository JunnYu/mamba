...
def cross_entropy_forward(_input, target, ignore_index, label_smoothing):
    ...
    liger_cross_entropy_kernel[(n_rows,)](
        ...
        Y_ptr=target,
        Y_stride=target.strides[-1],  # always 1
        loss_ptr=loss_1d,
        loss_stride=loss_1d.strides[-1],  # always 1
        n_cols=V,
...
class LigerCrossEntropyFunction(paddle.autograd.PyLayer):
    """
    This class implements a custom autograd function for the Liger Cross Entropy loss.
    It overrides the forward and backward methods of the paddle.autograd.PyLayer class.
    """
